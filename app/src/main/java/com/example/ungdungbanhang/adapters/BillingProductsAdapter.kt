...
import com.example.ungdungbanhang.databinding.BillingProductRvItemBinding
...
class BillingProductsAdapter: Adapter<BillingProductsAdapter.BillingProductsViewHolder>() {
    ...
    inner class BillingProductsViewHolder(val binding: BillingProductRvItemBinding): ViewHolder(binding.root) {
        ...
        fun bind(billingProduct: CartProduct) {
            binding.apply {
                ...
                tvProductCartPrice.text = formatPriceVN(priceAfterPercentage.toDouble())
