...
import com.example.ungdungbanhang.VAShopApplication
...
import com.example.ungdungbanhang.util.validateEmail
...
class UserAccountViewModel @Inject constructor(
    ...
    // ham lay thong tin nguoi dung tu firebase
    fun getUser(){
        ...
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<VAShopApplication>().contentResolver,
                    imageUri
                )
